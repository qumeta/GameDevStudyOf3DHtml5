...
module SoftEngine {
    ...
    export class Vertices {
        constructor(public Coordinates: Qumeta.Vector3, public Normal: Qumeta.Vector3, public WorldCoordinates: Qumeta.Vector3 | null = null, public TextureCoordinates: Qumeta.Vector2 | null = null) {
    ...
    export class Texture {
        private internalBuffer!: ImageData;
        constructor(filename: string, public width: number, public height: number) {
            this.width = width;
            this.height = height;
            this.load(filename);
        }
    ...
    export class Device {
        ...
        private processScanLine(data: {
            ndotla: number, ndotlb: number, ndotlc: number, ndotld: number,
            ua: number, ub: number, uc: number, ud: number,
            va: number, vb: number, vc: number, vd: number, currentY: number
        },
            va: Vertices, vb: Vertices, vc: Vertices, vd: Vertices, color: Qumeta.Color4,
            texture: Texture) {
        ...
        private drawTriangle(v1: Vertices, v2: Vertices, v3: Vertices, color: Qumeta.Color4, texture: Texture) {
