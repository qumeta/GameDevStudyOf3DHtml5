...
module SoftEngine {
    ...
    export class Device {
        ...
        private processScanLine(data: { ndotla: number, ndotlb: number, ndotlc: number, ndotld: number, currentY: number }, va: Vertices, vb: Vertices, vc: Vertices, vd: Vertices, color: Qumeta.Color4) {
        ...
        private drawTriangle(v1: Vertices, v2: Vertices, v3: Vertices, color: Qumeta.Color4) {
            ...
            var data = { ndotla: 0, ndotlb: 0, ndotlc: 0, ndotld: 0, currentY: 0 };
